...
- [`df4f941`](https://github.com/terracelab/lore-ai/commit/df4f9415a3c6f4afee66aad1cac2e3447286bef2) Thanks [@kyong-dev](https://github.com/kyong-dev)! - `sync` / `synthesize` 파이프라인 분리 + 변경 감지 + 보고서 포맷 프롬프트.
...
- Updated dependencies [[`df4f941`](https://github.com/terracelab/lore-ai/commit/df4f9415a3c6f4afee66aad1cac2e3447286bef2)]:
